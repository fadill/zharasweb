...
class BCA extends WC_Gateway_BACS {
	function __construct() {
		$this->id = "bank_bca";
		$this->method_title = __( "Epeken Transfer Bank BCA", 'woocommerce' );
		$this->method_description = __( "Lakukan setting payment lewat transfer Bank BCA di sini.", 'woocommerce' );
   ...
   public function init_form_fields() {
    $this->form_fields = array(
        'enabled' => array(
            ...
            'label'     => __( 'Enable Cara Bayar Transfer Bank BCA', 'woocommerce' ),
            'type'      => 'checkbox',
            'default'   => 'yes',
        ),
        'title' => array(
        ...
        'description' => array(
            ...
            'default'   => __( 'Transfer Bank BCA(Deskripsi Transfer)', 'woocommerce' ),
            'css'       => 'max-width:350px;'
        ),
        'instructions' => array(
                                ...
                                'default'     => 'Transfer Bank BCA(Instruksi Transfer)',
                                'desc_tip'    => true,
                        ),
