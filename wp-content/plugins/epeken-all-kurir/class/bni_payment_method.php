...
class BNI extends WC_Gateway_BACS {
	function __construct() {
		$this->id = "bank_bni";
		$this->method_title = __( "Epeken Transfer Bank BNI", 'woocommerce' );
		$this->method_description = __( "Lakukan setting payment lewat transfer Bank BNI di sini.", 'woocommerce' );
   ...
   public function init_form_fields() {
    $this->form_fields = array(
        'enabled' => array(
            ...
            'label'     => __( 'Enable Cara Bayar Transfer Bank BNI', 'woocommerce' ),
            'type'      => 'checkbox',
            'default'   => 'yes',
        ),
        'title' => array(
        ...
        'description' => array(
            ...
            'default'   => __( 'Transfer Bank BNI(Deskripsi Transfer)', 'woocommerce' ),
            'css'       => 'max-width:350px;'
        ),
        'instructions' => array(
                                ...
                                'default'     => 'Transfer Bank BNI(Instruksi Transfer)',
                                'desc_tip'    => true,
                        ),
 	...
 	public function thankyou_page( $order_id ) {
        ...
        private function bank_details( $order_id = '' ) {
                ...
                echo '<p>' . __( 'Silakan transfer ke rekening berikut ini untuk melakukan pembayaran selambatnya pada tanggal', 'woocommerce' ) .'  '.'<strong>'.date_i18n( get_option( 'date_format' ), strtotime( "tomorrow + 1day" ) ).'</strong>'.'</p>' . PHP_EOL;
