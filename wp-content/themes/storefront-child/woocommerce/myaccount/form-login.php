...
<div class="u-columns col2-set customer_login" id="customer_login">

	<ul class="account-tab-list">
		<li class="account-tab-item active">
		    <a class="account-tab-link" href="#login">LOGIN</a>
		</li>			 
		<li class="sep">/</li>
	...
	<div class="tab-content">
		<div class="u-column1 col-1 tabcontent active" id="login">
...
<?php if ( 'yes' === get_option( 'woocommerce_enable_myaccount_registration' ) ) : ?>
		...
		<div class="u-column2 col-2 tabcontent" id="register">
